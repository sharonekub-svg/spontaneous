...
('למדו את שמונת השניות הראשונות של ריקוד מסוים וצלמו את עצמכם','צרפו סרטון כהוכחה.',(select id from mission_categories where slug='creative'),'medium',5,20,'{video}','a_little','דורשת קצת יותר מאמץ, יצירתיות או יציאה קטנה מהשגרה — לכן היא שווה 5 נקודות.'),
